    ...
    return (
        <div className="fixed inset-0 bg-[#2b1d1a] z-[100] flex flex-col items-center justify-center text-[#faebd7]">
            <div className="w-full max-w-md px-4 sm:px-6 flex flex-col items-center">
                ...
                {/* Brand name */}
                <div className="font-serif text-2xl font-bold tracking-tight text-[#D4AF37] mb-5">
                    Brew &amp; Code
                </div>

                {/* Terminal message */}
                <div className="mb-3 font-mono text-[#D4AF37] text-sm sm:text-base h-6 w-full text-left">
